...
public class SliderSoundAndMusic : MonoBehaviour
{
    ...
    private void Start()
    {
        var musicVolume = PlayerPrefs.GetFloat(PlayerPref.MusicVolume, 1);
        var soundVolume = PlayerPrefs.GetFloat(PlayerPref.SoundVolume, 1);
    ...
    {
        PlayerPrefs.SetFloat(PlayerPref.MusicVolume, musicSlider.value);
    ...
    {
        PlayerPrefs.SetFloat(PlayerPref.SoundVolume, soundSlider.value);
